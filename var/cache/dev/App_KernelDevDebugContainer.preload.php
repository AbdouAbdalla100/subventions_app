...
require __DIR__.'/ContainerXKaCKhx/App_KernelDevDebugContainer.php';
require __DIR__.'/ContainerXKaCKhx/EntityManager_9a5be93.php';
require __DIR__.'/ContainerXKaCKhx/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerXKaCKhx/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getWebpackEncore_EntrypointLookupCollectionService.php';
require __DIR__.'/ContainerXKaCKhx/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerXKaCKhx/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerXKaCKhx/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerXKaCKhx/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerXKaCKhx/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerXKaCKhx/getValidator_ExpressionService.php';
require __DIR__.'/ContainerXKaCKhx/getValidator_EmailService.php';
require __DIR__.'/ContainerXKaCKhx/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerXKaCKhx/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerXKaCKhx/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerXKaCKhx/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerXKaCKhx/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerXKaCKhx/getSwiftmailer_TransportService.php';
require __DIR__.'/ContainerXKaCKhx/getSwiftmailer_Mailer_Default_Transport_RealService.php';
require __DIR__.'/ContainerXKaCKhx/getSwiftmailer_Mailer_Default_Plugin_MessageloggerService.php';
require __DIR__.'/ContainerXKaCKhx/getSwiftmailer_Mailer_DefaultService.php';
require __DIR__.'/ContainerXKaCKhx/getSwiftmailer_EmailSender_ListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getSessionService.php';
require __DIR__.'/ContainerXKaCKhx/getServicesResetterService.php';
require __DIR__.'/ContainerXKaCKhx/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_RememberMe_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_CheckRememberMeConditions_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Authenticator_RememberMeHandler_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Authenticator_RememberMe_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_Authenticator_FormLogin_MainService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getSecrets_VaultService.php';
require __DIR__.'/ContainerXKaCKhx/getRouting_LoaderService.php';
require __DIR__.'/ContainerXKaCKhx/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerXKaCKhx/getPropertyAccessorService.php';
require __DIR__.'/ContainerXKaCKhx/getMimeTypesService.php';
require __DIR__.'/ContainerXKaCKhx/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_Type_FormService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_Type_EntityService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_Type_ColorService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_ServerParamsService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_RegistryService.php';
require __DIR__.'/ContainerXKaCKhx/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerXKaCKhx/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerXKaCKhx/getErrorControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerXKaCKhx/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_Security_Voter_Security_Access_RoleHierarchyVoterService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurityVoterService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerXKaCKhx/getBatchActionDtoResolverService.php';
require __DIR__.'/ContainerXKaCKhx/getAdminContextResolverService.php';
require __DIR__.'/ContainerXKaCKhx/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerXKaCKhx/getContainer_GetenvService.php';
require __DIR__.'/ContainerXKaCKhx/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerXKaCKhx/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerXKaCKhx/getCache_SystemClearerService.php';
require __DIR__.'/ContainerXKaCKhx/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerXKaCKhx/getCache_AppClearerService.php';
require __DIR__.'/ContainerXKaCKhx/getTemplateControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getRedirectControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getFieldProviderService.php';
require __DIR__.'/ContainerXKaCKhx/getEntityUpdaterService.php';
require __DIR__.'/ContainerXKaCKhx/getEntityRepositoryService.php';
require __DIR__.'/ContainerXKaCKhx/getFiltersFormTypeService.php';
require __DIR__.'/ContainerXKaCKhx/getFileUploadTypeService.php';
require __DIR__.'/ContainerXKaCKhx/getCrudFormTypeService.php';
require __DIR__.'/ContainerXKaCKhx/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/ContainerXKaCKhx/getSlugConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getNumberConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getMoneyConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getDateTimeConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getCountryConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getCommonPreConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getCommonPostConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getChoiceConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getBooleanConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getAssociationConfiguratorService.php';
require __DIR__.'/ContainerXKaCKhx/getPaginatorFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getFormFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getFilterFactoryService.php';
require __DIR__.'/ContainerXKaCKhx/getExceptionListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getCrudResponseListenerService.php';
require __DIR__.'/ContainerXKaCKhx/getUserRepositoryService.php';
require __DIR__.'/ContainerXKaCKhx/getOrganismeRepositoryService.php';
require __DIR__.'/ContainerXKaCKhx/getAnnonceRepositoryService.php';
require __DIR__.'/ContainerXKaCKhx/getUserTypeService.php';
require __DIR__.'/ContainerXKaCKhx/getOrganismeTypeService.php';
require __DIR__.'/ContainerXKaCKhx/getSecurityControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getNotificationControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getFormUserControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getFormOrganismeControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getAccueilControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getUserCrudControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getOrganismeCrudControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getDashboardControllerService.php';
require __DIR__.'/ContainerXKaCKhx/getAnnonceCrudControllerService.php';
require __DIR__.'/ContainerXKaCKhx/get_Session_DeprecatedService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_Tbo4JjvService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_RAlqQ78Service.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_OpmhHvService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_ADIDLrfService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_W9y3dzmService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_CRG1JjdService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_AWPr3oyService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/ContainerXKaCKhx/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/ContainerXKaCKhx/get_Container_Private_SerializerService.php';
require __DIR__.'/ContainerXKaCKhx/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/ContainerXKaCKhx/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/ContainerXKaCKhx/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerXKaCKhx/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Controller\Admin\AnnonceCrudController';
$classes[] = 'App\Controller\Admin\DashboardController';
$classes[] = 'App\Controller\Admin\OrganismeCrudController';
$classes[] = 'App\Controller\Admin\UserCrudController';
$classes[] = 'App\Controller\Frontend\AccueilController';
$classes[] = 'App\Controller\Frontend\FormOrganismeController';
$classes[] = 'App\Controller\Frontend\FormUserController';
$classes[] = 'App\Controller\Frontend\NotificationController';
$classes[] = 'App\Controller\SecurityController';
$classes[] = 'App\Form\Type\OrganismeType';
$classes[] = 'App\Form\Type\UserType';
$classes[] = 'App\Repository\AnnonceRepository';
$classes[] = 'App\Repository\OrganismeRepository';
