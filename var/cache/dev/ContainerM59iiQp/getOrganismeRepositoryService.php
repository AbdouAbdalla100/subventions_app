 ...
 */
class getOrganismeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrganismeRepository' shared autowired service.
     *
     * @return \App\Repository\OrganismeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrganismeRepository.php';

        return $container->privates['App\\Repository\\OrganismeRepository'] = new \App\Repository\OrganismeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
